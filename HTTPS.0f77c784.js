...
var _createCountryList = require("./js/createCountryList");
var _createCountryListDefault = parcelHelpers.interopDefault(_createCountryList);
...
countryInputRef.addEventListener("input", (0, _lodashDebounceDefault.default)((e)=>{
    searchQuery = e.target.value;
    (0, _fetchCountriesDefault.default)(searchQuery).then((res)=>{
        if (res.length > 10) (0, _pnotifyJs.error)({
            title: "Request is not clear",
            text: "Too many matches found. Please enter a more specific query"
        });
        else if (res.length > 2 && res.length < 10) countryInfoBoxRef.innerHTML = (0, _createCountryListDefault.default)(res);
        else countryInfoBoxRef.innerHTML = (0, _createItemsDefault.default)(res);
    }).catch((error)=>error);
}, 500)); // dsadasd
...
},{}],"grIyt":[function() {},{}],"c4y47":[function() {},{}],"LnPoi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function createItems(array) {
    const item = array.map(({ name, population, capital, languages, flags })=>{
        return `
...
function createLanguages(languages) {
    return Object.values(languages).map((item)=>`<li class="language"><p class="text">${item}</p></li>`).join("");
} // 132132165

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"fvnNO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>createCountryList);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire2c13", {})

//# sourceMappingURL=HTTPS.0f77c784.js.map
