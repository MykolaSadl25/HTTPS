...
// const API_KEY = "724ab283c9b9ddd242536929e18861f6";
// let city = "";
// function getWeather(city) {
//   return fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${API_KEY}`).then(res=>res.json());
// }
// getWeather("London").then(res=>console.log(res))
// function createWeatherItems(array) {
//   const item = array.map((elem)=>{
//     const celcius = Math.floor(elem.main.temp - 273.15);
...
function getPictures(search) {
    return fetch(`https://pixabay.com/api/?key=55978698-0d602613e63391cce9d7defd1&image_type=photo&q=${searchQuery}`).then((res)=>res.json());
}
...
},{"lodash.debounce":"irvaP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire2c13", {})
